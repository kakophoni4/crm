...
ROLE_PERMISSIONS: dict[UserRole, frozenset[Permission]] = {
    ...
    UserRole.NULEVKA: frozenset({
        Permission.FILES_DOWNLOAD, Permission.FILES_UPLOAD, Permission.FILES_DELETE,
        Permission.PROFILE_PASSWORD_UPDATE, Permission.PROFILE_FULL_NAME_UPDATE,
        Permission.PROFILE_PRESENCE_UPDATE, Permission.PROFILE_AVAILABILITY_UPDATE,
    }),
    UserRole.KESHER: frozenset({Permission.FILES_DOWNLOAD, Permission.FILES_UPLOAD, Permission.FILES_DELETE, Permission.CASHROOM_MANAGE, Permission.PROFILE_PASSWORD_UPDATE, Permission.PROFILE_FULL_NAME_UPDATE, Permission.PROFILE_PRESENCE_UPDATE, Permission.PROFILE_AVAILABILITY_UPDATE}),
}
