...
ROLE_PERMISSIONS: dict[UserRole, frozenset[Permission]] = {
    ...
    UserRole.KESHER: frozenset({Permission.CASHROOM_MANAGE, Permission.PROFILE_PASSWORD_UPDATE, Permission.PROFILE_FULL_NAME_UPDATE, Permission.PROFILE_PRESENCE_UPDATE, Permission.PROFILE_AVAILABILITY_UPDATE}),
}
