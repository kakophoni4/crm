...
Корректировка: в тексте PDF «корректирующий (N)» (N = 1, 2, …) или «корректир…» в имени файла.  
Первичка: «первичный». Голое «уточненн…» в шаблоне СБИС не считается корректировкой.
